...
var LoginControl = function (_React$Component) {
  ...
  _createClass(LoginControl, [{
    ...
    value: function render() {
      ...
      var button = void 0;
      if (isLoggedIn) {
        button = React.createElement(LogoutButton, { onClick: function onClick() {
            return _this2.handleLogoutClick();
          } });
      } else {
        button = React.createElement(LoginButton, { onClick: function onClick() {
            return _this2.handleLoginClick();
          } });
      }
